...
/* Default memory layout for ESP32-H4 bootloader (MP revision) */
 ...
 *
 * Derived from IDF bootloader.ld.in: 
 * bootloader_usable_dram_end = 0x4085d350 - 0x2000
 */
#define BOOTLOADER_RAM_END                  0x4085B350
