...
{
#if defined(MCUBOOT_FLASH_MAP_CUSTOM_SOURCES)
    return flash_area_get_size(fap);
#elif defined(MCUBOOT_SWAP_USING_SCRATCH) || defined(MCUBOOT_SINGLE_APPLICATION_SLOT) || \
