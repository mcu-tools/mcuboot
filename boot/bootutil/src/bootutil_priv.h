...
/* Get offset of trailer aligned to either device erase unit or write block,
 ...
 * just "true".
 */
#if defined(MCUBOOT_DEV_WITHOUT_ERASE) && defined(MCUBOOT_DEV_WITH_ERASE)
#define device_requires_erase(fa) (flash_area_erase_required(fa))
#elif defined(MCUBOOT_DEV_WITH_ERASE)
