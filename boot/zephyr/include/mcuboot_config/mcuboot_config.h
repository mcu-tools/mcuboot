...
#ifdef CONFIG_BOOT_SERIAL_SMP_BUSY_RESPONSES
#define MCUBOOT_SERIAL_SMP_BUSY_RESPONSES
#endif /* CONFIG_BOOT_SERIAL_SMP_BUSY_RESPONSES */

#ifdef CONFIG_BOOT_SERIAL_IMG_UPLOAD_STALLING
#define MCUBOOT_BOOT_SERIAL_IMG_UPLOAD_STALLING 1
#define MCUBOOT_BOOT_SERIAL_IMG_UPLOAD_STALLING_TIMEOUT	\
        (CONFIG_BOOT_SERIAL_IMG_UPLOAD_STALLING_TIMEOUT)
#endif /* CONFIG_BOOT_SERIAL_IMG_UPLOAD_STALLING */
