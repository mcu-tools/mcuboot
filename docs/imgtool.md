...
an extra tag `--clear` shall bed provided to generate initial download images 
...
Please refer to now partially updated documention on [encrypted images](encrypted_images.md)
on how to genearte and manage keys used for image encryption.
